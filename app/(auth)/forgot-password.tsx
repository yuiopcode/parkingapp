            ...
            <SafeAreaView className="h-full bg-white">
                <View className="flex-col mx-5 inline-flex my-5 bg-white">
                    ...
                    <View className="flex-col mt-8">
                        <Text className="text-[#333333] text-3xl font-poppins-semibold leading-[30px] mb-2">Password recovery</Text>
                        <Text className="text-[#333333] text-m font-normal font-poppins leading-[21px] mt-2">
